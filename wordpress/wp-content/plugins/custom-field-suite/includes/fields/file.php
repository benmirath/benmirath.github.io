...
class cfs_file extends cfs_field
{
    ...
    ?>
        ...
        self.parent.cfs_div.siblings('.file_value').val('<?php echo $file_url; ?>');
    ...
    function format_value_for_api($value, $field = null)
    {
        if (ctype_digit($value))
        {
            ...
            // return ('id' == $return_value) ? $value : wp_get_attachment_url($value);
            // return ('id' == $return_value) ? (int) $value : $value;
            // return wp_get_attachment_url($value)
        }
        return $value;
        // return wp_get_attachment_url($value);
